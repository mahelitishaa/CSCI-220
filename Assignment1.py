...
# including the evaluated expression, followed by your categorization of the expression as a tautology, contingency, or contradiction.
...
# All sixteen should have two propositional variables p and q, even if the function uses only one or the other. Verify that the output matches what is expected.
...
def main():
    result = analyze_truth_table(f0, True)
    print(result)
    ...
    functions = [f0_false, f1_nor, f2_converse_nonimpl, f3_neg_p, f4_nimply, f5_neg_q, f6_xor, f7_nand, f8_and,
                 f9_xnor, f10_q, f11_impl, f12_p, f13_converse, f14_or, f15_true]
