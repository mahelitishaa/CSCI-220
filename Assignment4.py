...
# [6] In the standard game of poker, one is dealt a "hand" of five cards which is classified
# into one of several categories. For example, "Four of a Kind" means four cards of one rank and one card of
# another rank. "Full House'' means three cards of one rank, and two cards of another rank.
# We want to compute the number of possible ways to get a given hand. Then, use this function to compare your
# calculated answer with the known correct answer and then call it for all standard hands.
