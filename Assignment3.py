...
# [1] Define a function get_function_type(func, func_domain, func_co_domain) that receives a function "func" and
# two sets - domain and co_domain and determines whether the function passed in is "partial", "bijectve","injective",
# or "surjective". First, compute func_range by evaluating the function for each value of the domain.
...
# [2] Define functions that compute the following set operations. The first five functions are binary and should
# accept two arguments each, while the last function is unary and should accept only one argument. You
# may use built-in functions to your language or implement them yourself.
...
# skip question 6, not doing per class instructions
def q6():
    print("skip question 6")
